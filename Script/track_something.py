...
if __name__ == "__main__":
    ...
    for i in range(seq_latent.shape[1]):
        ...
        for i in range(6):
            ...
            # print(env.sim_character.body_info.get_name_list())
            # print(env.sim_character.body_info.get_body_velo())
            # print(env.sim_character.body_info.get_body_pos())
            # print(env.sim_character.body_info.get_body_quat())
            # print(env.sim_character.body_info.get_body_rot())
            # print(env.sim_character.body_info.get_body_force())
            # print(env.sim_character.body_info.get_body_torque())
            # print(env.sim_character.body_info.calc_center_of_mass())
            # print(env.sim_character.body_info.calc_com_by_body_state())
            # print(env.sim_character.body_info.calc_facing_com_by_body_state())
            # print(env.sim_character.body_info.calc_velo_com())
            # print(env.sim_character.body_info.calc_sum_mass_pos())
            # print(env.sim_character.body_info.calc_momentum())
            # print(env.sim_character.body_info.calc_angular_momentum())
        try:
